...
def generate_output(source_brief,output_type,tone=None,language=None,audience=None,detail_level=None,objective=None,style=None,):
    prompt = build_prompt(source_brief=source_brief,output_type=output_type,tone=tone,language=language,audience=audience,detail_level=detail_level,objective=objective,style=style,)
